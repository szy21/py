...
"""
exper = 'skc_'
pert = ['control','t5','e5','t15','e15',\
        'fixed_h2o','t5_fixed_h2o','e5_fixed_h2o','t15_fixed_h2o','e15_fixed_h2o']
perto = ['ctrl','t5','e5','t15','e15',\
         'fixwv','t5fixwv','e5fixwv','t15fixwv','e15fixwv']
plat = '/gfdl.ncrc3-default-repro/'
"""
diag = 'atmos_level'
diago = 'var2d'
var = 'vert_int_tdtsw_rad'
varo = 'swabs'
npert = np.size(pert)
ind = range(npert)
#ind = [5]
subdir = 'ts/monthly/3yr/'
yrC = '000401-000612'
#npert = 1
for i in ind:
